...
export const IconeVisaoGeral: Icone = (p) => (
  <Svg {...p}><path d="M3 13h8V3H3zM13 21h8V11h-8zM3 21h8v-6H3zM13 3v6h8V3z" /></Svg>
);
...
export const IconeChamada: Icone = (p) => (
  <Svg {...p}><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M3 10h18M8 2v4M16 2v4M8 15l2 2 4-4" /></Svg>
);
...
export const IconeEquipe: Icone = (p) => (
  <Svg {...p}><circle cx="9" cy="8" r="3.5" /><path d="M2.5 20c0-3.5 3-6 6.5-6s6.5 2.5 6.5 6" /><path d="M19 8v6M16 11h6" /></Svg>
);
export const IconeSolicitacoes: Icone = (p) => (
  <Svg {...p}><path d="M4 4h16v12H8l-4 4z" /><path d="M8 9h8M8 12h5" /></Svg>
);
export const IconeMaterial: Icone = (p) => (
  <Svg {...p}><path d="M4 19.5V5a2 2 0 0 1 2-2h13v16H6a2 2 0 0 0-2 2.5z" /><path d="M8 7h7M8 11h5" /></Svg>
);
export const IconeAtividades: Icone = (p) => (
  <Svg {...p}><path d="M9 3h6a1 1 0 0 1 1 1v1H8V4a1 1 0 0 1 1-1z" /><path d="M8 5H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" /><path d="M9 14l2 2 4-4" /></Svg>
);
...
export const IconeClipe: Icone = (p) => (
  <Svg {...p}><path d="m21 11-8.6 8.6a5.5 5.5 0 0 1-7.8-7.8l8.6-8.6a3.7 3.7 0 0 1 5.2 5.2l-8.6 8.6a1.8 1.8 0 0 1-2.6-2.6l8-8" /></Svg>
);
export const IconeEnviarArquivo: Icone = (p) => (
  <Svg {...p}><path d="M4 16v3a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-3" /><path d="M12 15V3M7 8l5-5 5 5" /></Svg>
);
...
export const IconePonto: Icone = (p) => (
  <Svg {...p}><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /><path d="M8 3.5 6 2M16 3.5 18 2" /></Svg>
);
