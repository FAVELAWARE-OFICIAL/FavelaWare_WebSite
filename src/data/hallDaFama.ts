...
export const equipeEdicaoIII: Omit<MembroEquipe, 'ano'>[] = [
  ...
  { nome: 'Ivan Santos', cargo: 'Coordenador', organizacao: 'AOPA', foto: '/imgs/team/ivan.webp', linkedin: 'https://www.linkedin.com/in/ivan-santos-248712114/' },
  ...
  { nome: 'Raquel de Matos', cargo: 'Curadoria de Material', organizacao: 'Ânima', foto: '/imgs/team/raquel.webp', linkedin: 'https://www.linkedin.com/in/raquel-matos-mauricio/' },
  { nome: 'Gabriel Evaristo', cargo: 'Curadoria de Material', organizacao: 'Ânima', foto: '/imgs/team/gabriel.webp' },
  { nome: 'Gabrielle Soares', cargo: 'Editora de Conteúdo', organizacao: 'Ânima', foto: '/imgs/team/gabrielle.webp', linkedin: 'https://www.linkedin.com/in/gabrielle-soares-teixeira/' },
  { nome: 'Lorraine Fernandes', cargo: 'Designer gráfico', organizacao: 'Ânima', foto: '/imgs/team/lorraine.webp', linkedin: 'https://www.linkedin.com/in/lorraine-vieira/' },
  { nome: 'Lucelho Silva', cargo: 'Líder Discente', organizacao: 'Ânima', foto: '/imgs/team/lucelho.webp', linkedin: 'https://www.linkedin.com/in/lucelhosilva' },
  { nome: 'Diego Manini', cargo: 'Instrutor Discente', organizacao: 'Ânima', foto: '/imgs/team/diego.webp', linkedin: 'https://www.linkedin.com/in/diego-manini-384549232' },
  { nome: 'Pedro Soares', cargo: 'Instrutor Discente', organizacao: 'Ânima', foto: '/imgs/team/pedro.webp', linkedin: 'https://www.linkedin.com/in/pedro-soares-9b42a927b/' },
